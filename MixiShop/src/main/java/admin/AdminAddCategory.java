...
public class AdminAddCategory extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("contentPage", "adminAddCategory.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (result > 0) {
            session.setAttribute("notification", "<i class=\"fa-solid fa-circle-check text-success\"></i> Thêm danh mục \"" + category.getName() + "\" thành công");
            session.setAttribute("notificationType", "success");
            doGet(request, response);
        } else {
            session.setAttribute("notification", "<i class=\"fa-solid fa-circle-xmark text-danger\"></i> Thêm danh mục \"" + category.getName() + "\" thất bại");
